        ...
        <div className="service-list col">
            ...
            <div className="service-box">
                <div className="sub-services">
                    <p>2 services</p>
                    <Link to="/services/online-meeting" className="btn btn-outline-primary btn-sm"><i className="fas fa-plus"></i></Link>
                </div>
            ...
            <div className="service-box">
                <div className="sub-services">
                    <p>2 services</p>
                    <Link to="/services/intern-support" className="btn btn-outline-primary btn-sm"><i className="fas fa-plus"></i></Link>
                </div>
                <div className="service-name">
            ...
            <div className="service-box">
                <div className="sub-services">
                    <p>1 service</p>
                    <Link to="/services/enotice" className="btn btn-outline-primary btn-sm"><i className="fas fa-plus"></i></Link>
                </div>
                <div className="service-name">
